...
function Hero() {
    ...
    const [targetText, setTargetText] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(fullText);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Hero.useEffect": ()=>{
            const detectLang = {
                "Hero.useEffect.detectLang": ()=>{
                    const combo = document.querySelector(".goog-te-combo");
                    const comboVal = combo?.value;
                    if (comboVal) return comboVal;
                    const cookie = document.cookie;
                    const match = cookie.split(";").find({
                        "Hero.useEffect.detectLang.match": (c)=>c.trim().startsWith("googtrans=")
                    }["Hero.useEffect.detectLang.match"]);
                    if (match) {
            ...
            const updateLang = {
                "Hero.useEffect.updateLang": ()=>setLang(detectLang())
            }["Hero.useEffect.updateLang"];
            updateLang();
            const combo = document.querySelector(".goog-te-combo");
            ...
            const typeLoop = {
                "Hero.useEffect.typeLoop": ()=>{
                    ...
                    if (i <= targetText.length) {
                        ...
                        }["Hero.useEffect.typeLoop"], pauseEnd);
                    }
                }
            }["Hero.useEffect.typeLoop"];
            // Start typing loop
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Hero.useEffect": ()=>{
            const readTranslatedText = {
                "Hero.useEffect.readTranslatedText": ()=>{
            ...
            const combo = document.querySelector(".goog-te-combo");
            const onChange = {
                "Hero.useEffect.onChange": ()=>setTimeout(readTranslatedText, 300)
            }["Hero.useEffect.onChange"];
...
_s(Hero, "+pHZLUSfBKlCpVSrWuVdfEKq4Eg=");
_c = Hero;
var _c;
        ...
        "ImageCarousel.useEffect": ()=>{
            const interval = setInterval({
                "ImageCarousel.useEffect.interval": ()=>{
                    setCurrentIndex({
                        "ImageCarousel.useEffect.interval": (prev)=>(prev + 1) % activeItems.length
                    }["ImageCarousel.useEffect.interval"]);
                }
            }["ImageCarousel.useEffect.interval"], 1500) // Increased from 1000ms to 1500ms for slower, smoother rotation
            ;
            return ({
...
_s(ImageCarousel, "0WbQoms5IDUO8nlN69i6bo59c/s=");
_c = ImageCarousel;
var _c;
...
//# sourceMappingURL=_74247b35._.js.map