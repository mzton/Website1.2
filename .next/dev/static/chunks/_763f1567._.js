...
;
;
const JWT_SECRET = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.JWT_SECRET || 'your-secret-key-change-in-production';
...
async function registerUser(data) {
    try {
        ...
        const existingUser = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].getUserByEmail(data.email);
        if (existingUser) {
            return {
        ...
        // Create user
        const user = {
            id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateId"])(),
            email: data.email,
            name: data.name,
            role: data.role,
            createdAt: new Date(),
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].createUser(userWithPassword);
        // Generate token
...
async function loginUser(data) {
    try {
        // Find user
        const userWithPassword = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].getUserByEmail(data.email);
        if (!userWithPassword) {
            return {
...
function getCurrentUser(token) {
    ...
    const user = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].getUserById(decoded.userId);
    if (!user) return null;
...
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            if (token) {
                const currentUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCurrentUser"])(token);
                if (currentUser) {
                    setUser(currentUser);
                } else {
...
//# sourceMappingURL=_763f1567._.js.map